...
function Banner() {
  return (
    <>
      <div className="max-width-2-xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-20">
          <div className="space-y-12">
            ...
            <p className="text-xl font-semibold">
              ...
              vel reiciendis ea, dolorum eum consequatur id.
            </p>
        ...
        <div className="order-1 w-full md:w-1/2">
            <img src = {banner} className = "w-90 h-85 ml-8 mt-3" alt="image"></img>
        </div>
      </div>
    </>
  );
